...
import { getConstraints, createConstraint, deleteConstraint, createRule, deleteRule } from '../../api/constraintService';
...
export default function TalentDetailModal({ talent, isOpen, onClose, onSuccess }) {
    ...
    async function fetchConstraints() {
        ...
        try {
            // The backend endpoint supports filtering by talent_id
