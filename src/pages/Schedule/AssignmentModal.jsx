...
export default function AssignmentModal({ assignment, dateOf, scheduleId, isOpen, onClose, onSuccess }) {
    ...
    async function fetchTalents() {
        try {
            ...
            // Only show active talents in the dropdown
    ...
    const handleSubmit = async (e) => {
        ...
        // If it's a draft (no scheduleId or scheduleId is 'draft'), handle locally
    ...
    return (
        <Modal
            isOpen={isOpen}
            onClose={onClose}
            title={assignment ? 'Edit Assignment' : 'Add Manual Assignment'}
            footer={
                <>
                    {assignment && (
                        <button
